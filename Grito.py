...
# Comprobar si se utiliza la GPU
...
base_image_path = keras.utils.get_file("perro.jpg", "https://i.imgur.com/pwsKT2G.jpeg")
...
display(Image(filename=style_reference_image_path, width=500, height=500))
